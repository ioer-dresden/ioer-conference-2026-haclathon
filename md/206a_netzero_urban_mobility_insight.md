...
<!-- #region id="415d830e" editable=true tags=["remove-cell"] -->
**Setup**
...
```python tags=["remove-cell"] outputId="7f0cd5ef-8faa-4fa9-a95f-fa95d055152c" colab={"base_uri": "https://localhost:8080/"} editable=true id="7e6514bb"
...
<!-- #region editable=true id="b8e7ac05" -->
```{warning}
This chapter is a work in progress.
```
<!-- #endregion -->

<!-- #region id="09a72a78" editable=true -->
...
```python id="f786850f" outputId="5aa56c01-64c2-4ffd-da92-cd708ca63486" colab={"base_uri": "https://localhost:8080/"}
INDICATORS = {
...
```python colab={"base_uri": "https://localhost:8080/"} outputId="c868135e-7331-41e0-8322-8a6a757ba7f1" id="e24cde1f"
COUNTRIES_URL = (
