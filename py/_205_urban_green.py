...
# %% editable=true deletable=true slideshow={"slide_type": ""} tags=["remove-cell"]
...
# %% deletable=true tags=["hide-input"] slideshow={"slide_type": "slide"} editable=true
for item in files:
    file = item["dataFile"]
    filename = file["filename"]
    output = data_dir / filename
...
# %% deletable=true tags=["hide-input"] editable=true slideshow={"slide_type": "slide"}
